...
var VimeoApi = {
	...
	load: function load(settings) {
		...
		if (typeof Vimeo !== 'undefined') {
			...
			VimeoApi.promise = VimeoApi.promise || mejs.Utils.loadScript('http://localhost:8001/player.js');
...
var vimeoIframeRenderer = {
	...
	name: 'noembed_iframe',
	options: {
		prefix: 'noembed_iframe'
	},

	canPlayType: function canPlayType(type) {
		return ~['video/noembed', 'video/x-noembed'].indexOf(type.toLowerCase());
	},
